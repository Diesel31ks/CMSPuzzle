...
public class Registration extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		if ((login == "") || (login == null) || (password == "") || 
			(password == null) || (firstName == "") || (firstName == null) || 
			(lastName == "") || (lastName == null) || (email == null) || 
			(!password.equals(passwordConfirm))||(password.length()>100) || (password.length()<8) || 
			(password.contains(" ")) || (password.contains("/r")) || (password.contains("/n"))){
...
//			getServletContext().getRequestDispatcher("/successLogin.jsp").forward(request, response);
			...
			String text = "Вы зарегистрированиы на сайте CMSPuzzle-1.0-SNAPSHOT <br>" +
					 	  ...
					 	  "<a href=\"10.9.2.159:8080/CMSPuzzle-1.0-SNAPSHOT/successLogin.jsp\" >Log in</a>";
			try{
			...
			e.printStackTrace();
			System.out.println("Letter was not sent. SMTP does not working now. Thanks, Alexej :(");
